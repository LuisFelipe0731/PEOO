...
class View:
    ...
    def cliente_inserir(nome, email, fone, data, senha):
        c = Cliente(0, nome, email, fone, data, senha)
        Clientes.inserir(c)
    ...
    def cliente_atualizar(id, nome, email, fone, data, senha):
        c = Cliente(id, nome, email, fone, data, senha)
